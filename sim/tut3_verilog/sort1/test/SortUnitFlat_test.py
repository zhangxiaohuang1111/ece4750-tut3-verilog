...
from ..SortUnitFlat import SortUnitFlat
...
def test_basic( cmdline_opts ):
  run_test_vector_sim( SortUnitFlat(), [ header_str,
...
def test_stream( cmdline_opts ):
  run_test_vector_sim( SortUnitFlat(),
...
def test_random( nbits, cmdline_opts ):
  ...
  run_test_vector_sim( SortUnitFlat(nbits),
